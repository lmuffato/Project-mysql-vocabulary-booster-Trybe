select concat(F1.FIRST_NAME, ' ', F1.LAST_NAME) 'Nome completo funcionario 1',
F1.SALARY "Salário funcionário 1",
  F1.PHONE_NUMBER "Telefone funcionário 1",
  concat(F2.FIRST_NAME, ' ', F2.LAST_NAME) 'Nome completo funcionario 2',
...
order by `Nome completo funcionario 1`, `Nome completo funcionario 2`;
