...
INNER JOIN hr.departments AS departamento
  ON empregados.EMPLOYEE_ID = historico_cargos.EMPLOYEE_ID AND historico_cargos.JOB_ID = cargos.JOB_ID AND empregados.DEPARTMENT_ID = departamento.DEPARTMENT_ID
