...
FROM employees AS e INNER JOIN job_history AS jh ON jh.employee_id = e.employee_id INNER JOIN departments AS d ON d.department_id = jh.department_id INNER JOIN jobs AS j ON j.job_id = jh.job_id
